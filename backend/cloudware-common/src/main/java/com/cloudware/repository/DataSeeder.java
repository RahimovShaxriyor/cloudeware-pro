...
public class DataSeeder {
    ...
    private void insertUser(String fullName, String email, String password, String role, String department, String phone) {
        ...
        jdbc.update("""
            ...
            VALUES (?,?,?,?,?,?,TRUE)
            ON CONFLICT(email) DO UPDATE SET full_name=EXCLUDED.full_name, role=EXCLUDED.role, department=EXCLUDED.department, phone=EXCLUDED.phone, password=EXCLUDED.password
            """, fullName, email, hashed, role, department, phone);
    }
